...
import { useMantineTheme, Modal, Text, Button, Group } from "@mantine/core";
    ...
    return (
        <div>
            ...
            >
                ...
                <Group>
                    <Button mt="sm" type="submit" onClick={(newInfo: any) => { setAddModalOpen(false) }}> Certo </Button>
                    <Button color="red" mt="sm" type="submit" onClick={(newInfo: any) => { setAddModalOpen(false) }}> Annulla </Button>
                </Group>
            </Modal>
        </div>
    );
